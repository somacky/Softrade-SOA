...
using CustomSoft.Template.Dominio.BanxicoService;
...
namespace CustomSoft.Template.Dominio
{
    public class Util
    {
        ...
        public static DgieWSPortClient ServicioBanxico()
        {
            var basicHttpBinding = new BasicHttpBinding()
            {
                MaxBufferSize = 2147483647,
            ...
            var endpoint =
                new EndpointAddress(
                    "http://www.banxico.org.mx/DgieWSWeb/DgieWS?WSDL");//189.206.73.106                       
            var servicioBanxico = new DgieWSPortClient(basicHttpBinding, endpoint);
            //if (servicioCatalogos.ClientCredentials != null)
            //{
            //    servicioCatalogos.ClientCredentials.UserName.UserName = "MAPC801211QD4";
            //    servicioCatalogos.ClientCredentials.UserName.Password = "u354C53Y1blC+jmtHRT6B17ep9pNXIarNNEryywCeYvjhL5jsYekS5ujNGQyx93k";
            //    //servicioCatalogos.ClientCredentials.UserName.UserName = "VECM6011173A2";
            //    //servicioCatalogos.ClientCredentials.UserName.Password = "rJ6/wsPzE4AWCNo9NhKEaQGUQkJl7RZQAJBeOAtqKajjR63zhEalSf/asMBZ1J4R";
            //}
            return servicioBanxico;
        }
    ...
    public class UtilUrl
    {
        ...
        public static byte[] Base64Encode(string cadena)
        {
            var cadenaByte = new byte[cadena.Length];
            cadenaByte = System.Text.Encoding.UTF8.GetBytes(cadena);
            //var encodedCadena = Convert.ToBase64String(cadenaByte);
            return cadenaByte;
        ...
        public static string Base64Decode(string cadena)
        {
            ...
            var cadenaByte = Convert.FromBase64String(cadena);
        ...
        public static string CodificarGuid(byte[] guidText)
        {
            Guid guid = new Guid(guidText);
            return CodificarGuid(guid);
        }

        public static string CodificarGuid(Guid guid)
        {
        ...
        public static Guid DecodeGuid(string encoded)
        {
